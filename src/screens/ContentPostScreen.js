              ...
              >
                <View style={styles.searchContainer}>
                  <Feather
                    ...
                    color="#fff"
                  />
                  <Text style={styles.userGreet}>Create Content</Text>
                </View>
              </LinearGradient>
              <View>
                <TouchableOpacity
                  onPress={() => props?.navigation?.navigate("ImageEdior")}
                >
                  <Text
                    style={{
                      textAlign: "center",
                  ...
                  >
                    Wanna create customized & creative Image?
                  </Text>
                </TouchableOpacity>

                <TouchableOpacity
                  onPress={() => props?.navigation?.navigate("ContentPreview")}
                >
                  <Text
                    style={{
                      textAlign: "center",
                  ...
                  >
                    Looking for Keyword? Try Quink Trends & Keywords
                  </Text>
                </TouchableOpacity>
                ...
                <TextInput
                  ...
                  placeholder="Short Description of your content (within 100 words)"
                  placeholderTextColor="#666"
                  value={caption}
